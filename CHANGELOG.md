...
### Changed
- **New Task Navigation** - Use Tab to move between task content, schedule, and project fields, and Left/Right to select a project while its field is focused

### Fixed
- **Completed Smart-View Tasks** - Keep completed tasks cached for Today history without showing them in Tomorrow or Upcoming
